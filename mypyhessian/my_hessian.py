...
from mypyhessian.myutils import group_product, group_add, normalization, get_params_grad, hessian_vector_product, orthnormal
...
class my_hessian():
    ...
    def __init__(self, model, data=None, dataloader=None, cuda=True):
        ...
        if not self.full_dataset:
            ...
            preds, _ = self.model(self.inputs, num_step=5)
